...
public class VIN {
    ...
    private ManufacturerMap manufacturerMap=ManufacturerMap.getDefault();
    ...
    public  String getManufacturer(){
        return manufacturerMap.get(getManufacturerCode());
    }
    ...
    public ManufacturerMap getManufacturerMap() {
        return manufacturerMap;
    }

    public void setManufacturerMap(ManufacturerMap manufacturerMap) {
